...
public struct DelimitedFieldDetector: EntityDetector {
    ...
    /// PHI in the document.
    private static func shapeAllows(_ column: (type: EntityType, disposition: Disposition), value: Substring) -> Bool {
    ...
    private static func normalise(_ header: String) -> String {
